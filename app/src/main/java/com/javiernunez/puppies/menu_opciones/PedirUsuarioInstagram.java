...
public class PedirUsuarioInstagram extends AppCompatActivity {
    ...
    //                    }
                ...
                intent.putExtra("usuario", nuevoUsuario);               //ToDo: debería poner los nombres en Strings
                intent.putExtra("usuarioID", nuevoID);                  //ToDo: debería poner los nombres en Strings
                intent.putExtra("usuarioURL", nuevaURL);                //ToDo: debería poner los nombres en Strings
